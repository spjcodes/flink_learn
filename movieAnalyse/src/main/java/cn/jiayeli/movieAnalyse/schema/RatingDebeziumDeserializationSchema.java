...
public class RatingDebeziumDeserializationSchema implements com.ververica.cdc.debezium.DebeziumDeserializationSchema<cn.jiayeli.movieAnalyse.module.RatingModule> {
    @Override
